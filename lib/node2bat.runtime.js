@if (0===0) @end/*! https://github.com/aui/node2bat | sugarpie.tang@gmail.com
@echo off
title loading..
cd %~dp0
...
(function (global, exports) {
    ...
    global.console = {
        ...
        __toSource: (function () {
            ...
            return function toSource (obj, space) {
                    space = space || 0;
                    ...
                    switch (type) {
                            case 'Object':
                                    ...
                                    for (var name in obj) {
                                            temp.push(
                                                    '\n' + getSpace(space + 4) + JSON.stringify(name) + ': ' + toSource(obj[name], space + 4)
                                            );
                                    }
                            ...
                            case 'Array':
                                    ...
                                    while (length) {
                                            temp[--length] = '\n' + getSpace(space + 4) + toSource(obj[length], space + 4);
                                    }
            ...
            writeFileSync: function (file, data, charset) {
                ...
                try {
                    ...
                    if (charset) {
                        ...
                        // 写入首字符  
                        stream.writeText(data.charAt(0));  
                        stream.setEOS();  
                        // 二进制模式读出首字符的字节数据  
                        stream.position = 0;  
                        stream.type = 1;  
                        ...
                        stream.writeText(data.substr(1), 0);
